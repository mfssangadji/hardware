...
<head>
  ...
  <title>eLearning Hardware</title>
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo e(route('welcome')); ?>" class="navbar-brand"><b>e</b>Learning</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pembelajaran <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(url('learn/'.$key)); ?>"><?php echo e($val); ?></a></li>
...
<?php /**PATH C:\xampp\htdocs\scripty\hardware\resources\views/app.blade.php ENDPATH**/ ?>